...
class SQLString {
    ...
    public static final String CREATE_TABLE_FACECOLLECTIOMITEM = "create table FaceCollectionItem (time varchar primary key, id integer, imgUri varchar not null, faceId varchar)";
