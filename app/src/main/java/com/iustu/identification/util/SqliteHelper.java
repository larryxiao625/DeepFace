...
class SQLString {
    ...
    public static final String CREATE_TABLE_FACECOLLECTIOMITEM = "create table FaceCollectionItem (originalPhoto varchar, time varchar, id integer primary key autoincrement, imgUrl varchar not null, faceId varchar)";
