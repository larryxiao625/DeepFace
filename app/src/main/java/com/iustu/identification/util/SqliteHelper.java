...
class SQLString {
    ...
    public static final String CREATE_TABLE_LIBRARY = "create table Library (int libId primary key autoincrement, libName varchar not null, description varchar, int count not null)";
    ...
    public static final String CREATE_TABLE_COMPARERECORD = "create table CompareRecord (time varchar primary key, uploadImagePath varchar not null, feature varchar not null, rate float not null)";
